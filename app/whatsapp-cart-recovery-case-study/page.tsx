    ...
    <main className="min-h-screen bg-[#030303]">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-gradient-to-b from-[#030303] via-[#0a0a1f] to-[#030303]">
        ...
        <div className="max-w-6xl mx-auto px-4 py-20 text-center relative z-10">
          <div className="inline-block mb-6 px-4 py-2 bg-green-500/10 border border-green-500/20 rounded-full backdrop-blur-sm">
            <span className="text-green-400 font-medium text-sm">Case Study</span>
          </div>

          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
            WhatsApp Cart Recovery <br />
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white/5 backdrop-blur-sm p-8 rounded-xl border border-white/10">
              ...
              <ul className="space-y-4 text-white/70">
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0 mt-0.5" />
                  <span>WhatsApp follow-ups sent with personal touch</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0 mt-0.5" />
          ...
          <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 backdrop-blur-sm p-8 sm:p-12 rounded-2xl border border-white/10">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="text-center">
                ...
                <p className="text-white/70">Follow-up Rate</p>
              </div>
              <div className="text-center">
                <div className="text-5xl font-bold bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent mb-2">
                  32%
            ...
            <p className="text-lg text-white/70 leading-relaxed text-center">
              More recovered orders, more customer conversations, and increased revenue without heavy discounts.
              WhatsApp proved to be the most effective channel for reaching shoppers in real-time with personalized
              recovery messages.
            </p>
          </div>
        </div>
      ...
      <section className="py-20 bg-[#030303] relative">
        <div className="max-w-4xl mx-auto px-4 relative">
          <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 backdrop-blur-sm p-8 sm:p-12 rounded-2xl border border-white/10">
            ...
            <Link
              href="/"
              className="inline-block px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-lg hover:from-green-700 hover:to-emerald-700 transition-all duration-300 font-semibold shadow-lg shadow-green-500/25 hover:shadow-green-500/40 transform hover:-translate-y-0.5"
            >
              Try BoostACart Free
            </Link>
          </div>
      ...
      <section className="py-20 bg-[#030303] relative">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-green-900/5 to-transparent"></div>
        <div className="max-w-4xl mx-auto px-4 relative">
          <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 backdrop-blur-sm p-8 sm:p-12 rounded-2xl border border-white/10 text-center">
            ...
            <Link
              href="/auth/sign-up"
              className="inline-block px-8 py-4 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-xl hover:from-green-700 hover:to-emerald-700 transition-all duration-300 font-semibold text-lg shadow-lg shadow-green-500/25 hover:shadow-green-500/40 transform hover:-translate-y-0.5"
            >
              Start Free Trial
            </Link>
          </div>
