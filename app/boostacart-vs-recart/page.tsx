        ...
        <div className="max-w-4xl mx-auto px-4 relative">
          <div className="bg-white/5 backdrop-blur-sm p-8 sm:p-12 rounded-2xl border border-white/10">
            <p className="text-lg text-white/70 leading-relaxed">
              Both BoostACart and Recart focus on cart recovery, but they capture leads at different stages. This
              comparison explains the key differences and how to choose the right tool.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 relative">
          <div className="bg-gradient-to-br from-orange-500/10 to-amber-500/10 backdrop-blur-sm p-8 sm:p-12 rounded-2xl border border-white/10">
            ...
            <p className="text-lg text-white/70 leading-relaxed mb-6">
              <strong className="text-white">BoostACart</strong> captures leads at Add-to-Cart stage, before customers
              even reach checkout.
            </p>
            <p className="text-lg text-white/70 leading-relaxed">
              <strong className="text-white">Recart</strong> captures leads at and after checkout stage, focusing on
              customers who started the checkout process.
            </p>
            <p className="text-lg text-white/70 leading-relaxed mt-6">
              This means BoostACart reaches customers earlier when intent is highest, recovering shoppers Recart never
              sees.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-6">
            <div className="bg-white/5 backdrop-blur-sm p-6 sm:p-8 rounded-xl border border-white/10">
              ...
              <p className="text-white/70">
                <strong className="text-white">BoostACart:</strong> At Add-to-Cart (before checkout)
              </p>
              <p className="text-white/70">
                <strong className="text-white">Recart:</strong> At checkout page
              </p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm p-6 sm:p-8 rounded-xl border border-white/10">
              ...
              <p className="text-white/70">
                <strong className="text-white">BoostACart:</strong> Yes, built-in
              </p>
              <p className="text-white/70">
                <strong className="text-white">Recart:</strong> Yes, available
              </p>
            </div>

            <div className="bg-white/5 backdrop-blur-sm p-6 sm:p-8 rounded-xl border border-white/10">
              <h3 className="text-xl font-bold text-white mb-3">SMS Messaging</h3>
              <p className="text-white/70">
                <strong className="text-white">BoostACart:</strong> Yes, included
              </p>
              <p className="text-white/70">
                <strong className="text-white">Recart:</strong> Yes, SMS available
              </p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm p-6 sm:p-8 rounded-xl border border-white/10">
              ...
              <p className="text-white/70">
                <strong className="text-white">BoostACart:</strong> Basic email included
              </p>
              <p className="text-white/70">
                <strong className="text-white">Recart:</strong> Advanced email flows
              </p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm p-6 sm:p-8 rounded-xl border border-white/10">
              ...
              <p className="text-white/70">
                <strong className="text-white">BoostACart:</strong> Very simple, one-click setup
              </p>
              <p className="text-white/70">
                <strong className="text-white">Recart:</strong> User-friendly but more complex
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 relative">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white/5 backdrop-blur-sm p-8 rounded-xl border border-white/10">
              <h3 className="text-2xl font-bold text-orange-400 mb-6">Choose BoostACart If:</h3>
              <ul className="space-y-3 text-white/70">
                <li>• You want to capture Add-to-Cart abandoners (40%+ of all abandonment)</li>
                <li>• You want the simplest possible setup</li>
                <li>• You want a cost-effective solution</li>
                <li>• You focus on WhatsApp and SMS messaging</li>
              </ul>
            </div>

            <div className="bg-white/5 backdrop-blur-sm p-8 rounded-xl border border-white/10">
              <h3 className="text-2xl font-bold text-amber-400 mb-6">Choose Recart If:</h3>
              <ul className="space-y-3 text-white/70">
                <li>• You only focus on post-checkout recovery</li>
                <li>• You need advanced email automation flows</li>
                <li>• You want all features in one platform</li>
                <li>• You're willing to invest in more complex setup</li>
              </ul>
            </div>
          </div>

          <div className="mt-8 bg-gradient-to-br from-orange-500/10 to-amber-500/10 backdrop-blur-sm p-8 sm:p-10 rounded-2xl border border-white/10">
            <p className="text-lg text-white/70">
              <strong className="text-white">Winning Combination:</strong> Smart merchants use BoostACart to capture
              Add-to-Cart abandoners with quick SMS and WhatsApp, then use Recart for post-checkout follow-ups. This
              covers both stages and recovers significantly more revenue.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 relative">
          <div className="bg-gradient-to-r from-orange-600/20 to-amber-600/20 backdrop-blur-sm p-8 sm:p-12 rounded-2xl text-white border border-white/10 text-center">
            ...
            <p className="text-lg text-white/70 mb-8">
              Capture the 40%+ of customers who abandon before checkout. Try BoostACart free today.
            </p>
