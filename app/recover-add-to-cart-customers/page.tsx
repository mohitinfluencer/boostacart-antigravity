...
export const metadata: Metadata = {
  title: "Recover Add-to-Cart Customers – BoostACart",
  description:
...
export default function RecoverAddToCartCustomersPage() {
  return (
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-gradient-to-b from-[#030303] via-[#0a0a1f] to-[#030303]">
        ...
        <div className="max-w-6xl mx-auto px-4 py-20 text-center relative z-10">
          <div className="inline-block mb-6 px-4 py-2 bg-blue-500/10 border border-blue-500/20 rounded-full backdrop-blur-sm">
            <span className="text-blue-400 font-medium text-sm">Customer Recovery</span>
          </div>
      ...
      <section className="py-20 bg-[#030303] relative">
        ...
        <div className="max-w-4xl mx-auto px-4 relative">
          <div className="bg-gradient-to-r from-blue-600/20 to-cyan-600/20 backdrop-blur-sm p-8 sm:p-12 rounded-2xl text-white border border-white/10 text-center">
            <h3 className="text-3xl sm:text-4xl font-bold mb-4">Ready to Recover Customers?</h3>
            <p className="text-lg text-white/70 mb-6 leading-relaxed">
              Start capturing leads at Add-to-Cart and recover more customers.
            </p>
            ...
            <Link
              href="/auth/sign-up"
              className="px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-xl hover:from-blue-700 hover:to-cyan-700 transition-all duration-300 font-semibold text-lg shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 transform hover:-translate-y-0.5 inline-flex items-center justify-center"
            >
              Try BoostaCart Free
            </Link>
          </div>
