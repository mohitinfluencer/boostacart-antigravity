...
export default function CollectEmailAtAddToCartPage() {
  return (
    <main className="min-h-screen bg-[#030303]">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-gradient-to-b from-[#030303] via-[#0a0a1f] to-[#030303]">
        ...
        <div className="max-w-6xl mx-auto px-4 py-20 text-center relative z-10">
          <div className="inline-block mb-6 px-4 py-2 bg-violet-500/10 border border-violet-500/20 rounded-full backdrop-blur-sm">
            <span className="text-violet-400 font-medium text-sm">Email Capture</span>
          </div>
      ...
      {/* Example Use Case */}
      <section className="py-20 bg-[#030303] relative">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-fuchsia-900/5 to-transparent"></div>
        <div className="max-w-4xl mx-auto px-4 relative">
      ...
      <section className="py-20 bg-[#030303] relative">
        ...
        <div className="max-w-4xl mx-auto px-4 relative">
          <div className="bg-gradient-to-r from-violet-600/20 to-purple-600/20 backdrop-blur-sm p-8 sm:p-12 rounded-2xl text-white border border-white/10 text-center">
            <h3 className="text-3xl sm:text-4xl font-bold mb-4">Ready to Build Your Email List?</h3>
            <p className="text-lg text-white/70 mb-6 leading-relaxed">
              Start collecting emails at Add-to-Cart and grow your customer database instantly.
            </p>
            <div className="bg-violet-500/10 backdrop-blur-sm p-4 rounded-xl border border-violet-400/20 mb-8">
              <p className="text-base text-violet-300 italic">
