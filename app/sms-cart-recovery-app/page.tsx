...
export const metadata: Metadata = {
  title: "SMS Cart Recovery App – BoostACart",
  description:
...
export default function SmsCartRecoveryAppPage() {
  return (
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-gradient-to-b from-[#030303] via-[#0a0a1f] to-[#030303]">
        ...
        <div className="max-w-6xl mx-auto px-4 py-20 text-center relative z-10">
          <div className="inline-block mb-6 px-4 py-2 bg-pink-500/10 border border-pink-500/20 rounded-full backdrop-blur-sm">
            <span className="text-pink-400 font-medium text-sm">SMS Marketing</span>
          </div>
      ...
      <section className="py-20 bg-[#030303] relative">
        ...
        <div className="max-w-4xl mx-auto px-4 relative">
          <div className="bg-gradient-to-r from-pink-600/20 to-rose-600/20 backdrop-blur-sm p-8 sm:p-12 rounded-2xl text-white border border-white/10 text-center">
            <h3 className="text-3xl sm:text-4xl font-bold mb-4">Ready to Send SMS Reminders?</h3>
            <p className="text-lg text-white/70 mb-6 leading-relaxed">
              Start capturing leads at Add-to-Cart and recover more sales via SMS.
            </p>
            <div className="bg-pink-500/10 backdrop-blur-sm p-4 rounded-xl border border-pink-400/20 mb-8">
              <p className="text-base text-pink-300 italic">
                BoostACart is currently in beta. Get priority access and support.
              </p>
            </div>
            <Link
              href="/auth/sign-up"
              className="px-8 py-4 bg-gradient-to-r from-pink-600 to-rose-600 text-white rounded-xl hover:from-pink-700 hover:to-rose-700 transition-all duration-300 font-semibold text-lg shadow-lg shadow-pink-500/25 hover:shadow-pink-500/40 transform hover:-translate-y-0.5 inline-flex items-center justify-center"
            >
              Try BoostaCart Free
            </Link>
          </div>
