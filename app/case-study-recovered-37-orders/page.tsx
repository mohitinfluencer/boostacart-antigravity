  ...
  return (
    <main className="min-h-screen bg-[#030303]">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-gradient-to-b from-[#030303] via-[#0a0a1f] to-[#030303]">
        ...
        <div className="max-w-6xl mx-auto px-4 py-20 text-center relative z-10">
          <div className="inline-block mb-6 px-4 py-2 bg-blue-500/10 border border-blue-500/20 rounded-full backdrop-blur-sm">
            <span className="text-blue-400 font-medium text-sm">Case Study</span>
          </div>

          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
            How We Recovered 37 Orders <br />
      ...
      <section className="py-20 bg-[#030303] relative">
        ...
        <div className="max-w-4xl mx-auto px-4 relative">
          <div className="bg-gradient-to-br from-green-500/10 to-cyan-500/10 backdrop-blur-sm p-8 sm:p-12 rounded-2xl border border-white/10">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="text-center">
                ...
                <p className="text-white/70">Orders Recovered</p>
              </div>
              <div className="text-center">
                <div className="text-5xl font-bold bg-gradient-to-r from-green-400 to-cyan-400 bg-clip-text text-transparent mb-2">
                  $12K+
              ...
              <div className="text-center">
                ...
                <p className="text-white/70">Time Frame</p>
              </div>
            </div>
            ...
            <p className="text-lg text-white/70 leading-relaxed text-center">
              ...
              store was able to reach out to interested shoppers who were on the fence, resulting in significantly
              higher conversion rates on follow-up communications.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#030303] relative">
        <div className="max-w-4xl mx-auto px-4 relative">
          <div className="bg-gradient-to-br from-blue-500/10 to-cyan-500/10 backdrop-blur-sm p-8 sm:p-12 rounded-2xl border border-white/10">
            ...
            <Link
              href="/"
              className="inline-block px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-lg hover:from-blue-700 hover:to-cyan-700 transition-all duration-300 font-semibold shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 transform hover:-translate-y-0.5"
            >
              Try BoostACart Free
            </Link>
          </div>
      ...
      <section className="py-20 bg-[#030303] relative">
        ...
        <div className="max-w-4xl mx-auto px-4 relative">
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-500/10 backdrop-blur-sm p-8 sm:p-12 rounded-2xl border border-white/10 text-center">
            ...
            <Link
              href="/auth/sign-up"
              className="inline-block px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-xl hover:from-blue-700 hover:to-cyan-700 transition-all duration-300 font-semibold text-lg shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 transform hover:-translate-y-0.5"
            >
              Start Free Trial
            </Link>
          </div>
      ...
      <section className="py-20 bg-[#030303] relative">
        ...
        <div className="max-w-4xl mx-auto px-4 relative">
          <div className="bg-gradient-to-r from-blue-600/20 to-cyan-600/20 backdrop-blur-sm p-8 sm:p-12 rounded-2xl text-white border border-white/10 text-center">
            <h3 className="text-3xl sm:text-4xl font-bold mb-4">Ready to Start Recovering Orders?</h3>
            <p className="text-lg text-white/70 mb-8">
              Join stores already using BoostACart to recover lost sales and grow revenue
            </p>
            ...
            <div className="text-blue-300 text-sm italic">
              <Link href="/cart-recovery-tool-for-shopify" className="hover:text-blue-200 transition-colors">
                Learn more about cart recovery tools →
              </Link>
            </div>
          </div>
        </div>
