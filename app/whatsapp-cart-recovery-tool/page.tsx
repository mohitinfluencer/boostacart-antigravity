      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-gradient-to-b from-[#030303] via-[#0a0a1f] to-[#030303]">
        ...
        <div className="max-w-6xl mx-auto px-4 py-20 text-center relative z-10">
          <div className="inline-block mb-6 px-4 py-2 bg-green-500/10 border border-green-500/20 rounded-full backdrop-blur-sm">
            <span className="text-green-400 font-medium text-sm">WhatsApp Integration</span>
          </div>
      ...
      <section className="py-20 bg-[#030303] relative">
        ...
        <div className="max-w-4xl mx-auto px-4 relative">
          <div className="bg-gradient-to-r from-green-600/20 to-emerald-600/20 backdrop-blur-sm p-8 sm:p-12 rounded-2xl text-white border border-white/10 text-center">
            <h3 className="text-3xl sm:text-4xl font-bold mb-4">Ready to Use WhatsApp for Recovery?</h3>
            <p className="text-lg text-white/70 mb-6 leading-relaxed">
              Start capturing leads at Add-to-Cart and recover more sales via WhatsApp.
            </p>
            <div className="bg-green-500/10 backdrop-blur-sm p-4 rounded-xl border border-green-400/20 mb-8">
