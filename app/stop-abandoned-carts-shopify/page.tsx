...
export const metadata: Metadata = {
  title: "Stop Abandoned Carts on Shopify – BoostACart",
  description:
...
export default function StopAbandonedCartsShopifyPage() {
  return (
    <main className="min-h-screen bg-[#030303]">
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-gradient-to-b from-[#030303] via-[#0a0a1f] to-[#030303]">
        ...
        <div className="max-w-6xl mx-auto px-4 py-20 text-center relative z-10">
          <div className="inline-block mb-6 px-4 py-2 bg-teal-500/10 border border-teal-500/20 rounded-full backdrop-blur-sm">
            <span className="text-teal-400 font-medium text-sm">Cart Abandonment</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/auth/sign-up"
              className="px-8 py-4 bg-gradient-to-r from-teal-600 to-cyan-600 text-white rounded-xl hover:from-teal-700 hover:to-cyan-700 transition-all duration-300 font-semibold text-lg shadow-lg shadow-teal-500/25 hover:shadow-teal-500/40 transform hover:-translate-y-0.5 flex items-center justify-center"
            >
              Try BoostaCart Free
            </Link>
            <Link
      ...
      <section className="py-20 bg-[#030303] relative">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-teal-900/5 to-transparent"></div>
        <div className="max-w-4xl mx-auto px-4 relative">
          <div className="bg-gradient-to-br from-teal-500/10 to-cyan-500/10 backdrop-blur-sm p-8 sm:p-12 rounded-2xl border border-white/10">
      ...
      <section className="py-20 bg-[#030303] relative">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-teal-900/5 to-transparent"></div>
        <div className="max-w-4xl mx-auto px-4 relative">
          <div className="bg-gradient-to-r from-teal-600/20 to-cyan-600/20 backdrop-blur-sm p-8 sm:p-12 rounded-2xl text-white border border-white/10 text-center">
            <h3 className="text-3xl sm:text-4xl font-bold mb-4">Ready to Stop Cart Abandonment?</h3>
            <p className="text-lg text-white/70 mb-6 leading-relaxed">
              Implement cart recovery on Shopify and prevent lost sales.
            </p>
            <div className="bg-teal-500/10 backdrop-blur-sm p-4 rounded-xl border border-teal-400/20 mb-8">
              <p className="text-base text-teal-300 italic">
                BoostACart is currently in beta. Get priority access and support.
              </p>
            </div>
            <Link
              href="/auth/sign-up"
              className="px-8 py-4 bg-gradient-to-r from-teal-600 to-cyan-600 text-white rounded-xl hover:from-teal-700 hover:to-cyan-700 transition-all duration-300 font-semibold text-lg shadow-lg shadow-teal-500/25 hover:shadow-teal-500/40 transform hover:-translate-y-0.5 inline-flex items-center justify-center"
            >
              Try BoostaCart Free
            </Link>
          </div>
